...
while Game_continue:
    ...
    if sum(my_card)>21:
        ...
        print("5. Computer Win")

    print(f" 당신의 최종합 : {final_me}")
    print(f" 컴퓨터 최종합 : {final_computer}")
    con=input("Do you wnat to play a game of Blackjack? Type 'y' or 'n' : ")
    if con=="n":
        Game_continue=False
'''

# 룰을 제대로 숙지하고 순서도보고 하는 과정이 더 중요한것 같다.
# 성격급하게 무작정 시작하지말고 순서도부터 파악 잘하기!
###################################################################################